        ...
        input: [
          {
            role: "system",
            content:
              "あなたは来院前の電話内容を、医師や管理者に渡すためのメモへ整理する補助者です。診断や判断はせず、電話で聞き取れた患者情報、症状、経過、希望、医師に確認したいことを分かりやすくまとめてください。不確かな情報は不明と書き、会話にない内容を補わないでください。"
          },
          {
            role: "user",
            content: `次の来院前電話の文字起こしから、医師・管理者に渡すメモを日本語で作成してください。

目的は、医師に患者情報と確認したいことが伝わるように整理することです。S/O形式にはこだわらなくてよいです。
